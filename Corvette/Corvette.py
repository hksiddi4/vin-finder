...
if int(year) == 2019 and urlChosenList is None:
    while True:
        zr1 = input('ZR1? (Y/N)\n').strip().lower()
...
if int(year) >= 2025 and urlChosenList is None:
    while True:
        ...
        if zr1 == "y":
            ...
            print("Please enter Y or N.")
if int(year) >= 2024 and urlChosenList is None:
    while True:
        ...
        if eray == "y":
            ...
            print("Please enter Y or N.")
if int(year) >= 2023 and urlChosenList is None:
    while True:
